...
def _ctx(sim, strategies, *, policy, trailing=False):
    return types.SimpleNamespace(
        ...
        # fields the live BotContext carries (added with the veto/evolve
        # feature set) — the mock must match or handle_bar AttributeErrors
        veto_fn=None, evolve_floor=0.35, evolve_ceil=1.0,
        on_trade_close=None, last_trade=None,
        on_signal=None, edge_gate=None)
