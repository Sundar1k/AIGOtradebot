...
class TrailExitSim:
    ...
    def step(self, action: int):
        ...
        # Asymmetric reward (#11): penalize losing moves more than winning ones
        # so the policy is more loss-averse (config.PPO_LOSS_PENALTY, 1.0 = symmetric).
        reward = delta if delta >= 0 else delta * config.PPO_LOSS_PENALTY
