...
# Legacy-bundle parity (2026-08-22): the shipped bundles (3-min and 15-min)
# were trained on the vanilla 256-d mean-pooled Chronos embedding, but the
# futures_foundation library now appends +7 return-shape scalars by default
# (CHRONOS_RETURN_SHAPE on) — which made the PPO proba precompute feed 341
# features into a 334-feature signal head ("Feature shape mismatch"). Force
# the documented legacy switch so precompute matches the bundles exactly.
os.environ.setdefault("CHRONOS_RETURN_SHAPE", "0")
